...
Algoritmo LaGranVuelta
	...
	Definir otroreg, orden, auxn, auxa Como Caracter;
	...
	Repetir
		...
		sino si (registro == falso)
				...
				Escribir "** (Si no se ha realizado el proceso de inscripciones) **";
		...
		Segun orden Hacer
			opcion '1':
				para dia=1 hasta 5 con paso 1 hacer
					...
					Escribir " Hoy [día ", dia, "] se registraron: ";
					Escribir "";
